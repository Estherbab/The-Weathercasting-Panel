...
console.log(weatherIconURL)
    ...
    if (i == 4) {
      ...
      humidoneDiv.textContent =
        "Humidity: " + forecastData.list[i].main.humidity + "%"; // The text content of the humidity section in html is populated with the forecastData from openweather using dot notation to access the specific data in the console.log
    }
    ...
    if (i == 20) {
      ...
      datethreeDiv.textContent = dayjs()
        .add(3, "day")
        .set("hour", 12)
        .set("minute", 0)
        .set("second", 0);
    ...
    if (i == 36) {
      ...
      windfiveDiv.textContent =
        "Wind: " + forecastData.list[i].wind.speed + "m/s";
      humidfiveDiv.textContent =
        "Humidity: " + forecastData.list[i].main.humidity + "%";
    }
  }
}

// function to log previous city once the submit form has been clicked
